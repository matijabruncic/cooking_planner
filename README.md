...
```
sudo docker run -d -e MYSQL_ROOT_PASSWORD=pass -v /home/bruncici/IdeaProjects/cooking-planner/baza/:/var/lib/mysql -p 3306:3306 --name sqlserver mysql
sudo docker exec -it sqlserver mysql -u root -p
